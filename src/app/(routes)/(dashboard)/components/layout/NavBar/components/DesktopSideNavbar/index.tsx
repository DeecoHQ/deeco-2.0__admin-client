...
const sidebarLinks = [
  ...
  { path: '/products', label: 'Products', icon: <HiMiniViewColumns className="text-[18px]" /> },
  { path: '/customers', label: 'Customers', icon: <HiUserGroup className="text-[18px]" /> },
  { path: '/brands', label: 'Brands', icon: <HiMiniQueueList className="text-[18px]" /> },
  { path: '/categories', label: 'Categories', icon: <HiMiniSquaresPlus className="text-[18px]" /> },
