...
export default function CategoriesPage() {
  return (
    <main className="p-6 min-h-screen flex flex-col">
      <PageRoutesIndicator pageRoutes="Admin / Categories Page" pageTitle="Categories Page" />
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-semibold mb-2">Categories Overview</h2>
          <p className="text-gray-600">This is some dummy text for the Categories page.</p>
        </div>
      </div>
    </main>
  );
